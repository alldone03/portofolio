...
export const PROFILE_DATA = {
  ...
  organization: [
    // {
    //   name: "ITS Robotics Team",
    //   role: "Electronic Staff of IRIS (ITS Robots with Intelligent System)",
    //   period: "2022 - 2023",
    //   description: "Collaborated in designing and maintaining the electronic systems for soccer robots. Competed in national and international robotics competitions, contributing to team strategy and technical problem-solving."
    // },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      details:
        "This project focused on analog circuit design, using op-amps for PID calculation instead of a digital microcontroller, achieving extremely low latency.",
      image:
  ...
  certifications: [
    {
      ...
      link: "https://www.yokogawa.co.id/", // placeholder for now
      image:
